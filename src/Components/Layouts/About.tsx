            ...
            <div className="right-content">
                ...
                <ul className="icon-list">
                    <li className="icon-item">
                        ...
                        <ArrowUpward style={{ width: '32px', height: '32px', display: 'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: '#FFFFFF12', borderRadius: '20px', padding: '6px', transform: 'rotate(45deg)' }} />
                    </li>
